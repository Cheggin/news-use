...
export function Header() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/Cheggin/news-use")
      .then((res) => res.json())
    ...
    <header className="border-b border-zinc-800 bg-black/50 backdrop-blur-sm fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* GitHub Star Button */}
          <a
            href="https://github.com/Cheggin/news-use"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center space-x-2 px-3 py-1.5 bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 hover:border-zinc-600 rounded-lg transition-all duration-200 group"
          >
            <svg
            ...
            <div className="flex items-center space-x-0.5 ml-1 px-2 py-0.5 bg-zinc-800/50 rounded border border-zinc-700/50">
              <svg
